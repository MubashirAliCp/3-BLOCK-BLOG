...
import { fetchCategoriesAction ,updateCategoriesAction,deleteCategoriesAction} from "../../redux/slices/Category/categorySlice";
...
const UpdateCategory = (props)=>{
  ...
  const {id} = useParams()
useEffect(()=>{
  dispatch(fetchCategoriesAction(id))
}, []);
  ...
  // if (isCreated)   <Redirect to="/category-list" />;
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        {/* Form */}
        <form
         onSubmit={formik.handleSubmit} className="mt-8 space-y-6"
         >
